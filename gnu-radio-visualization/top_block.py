...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._rf_gain_range = Range(-100, 100, 1, 45, 200)
        ...
        self._if_gain_range = Range(-100, 100, 1, 20, 200)
        ...
        self._center_freq_range = Range(2.3e9, 2.6e9, 100e6, 2.5e9, 200)
        ...
        self._bb_gain_range = Range(-100, 100, 1, 20, 200)
    ...
    def set_center_freq(self, center_freq):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.center_freq, 1e2)
